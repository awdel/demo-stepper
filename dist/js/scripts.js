...
_js_tabs__WEBPACK_IMPORTED_MODULE_1__["Tabs"].init();
...
var Tabs = function Tabs() {
  ...
  obj.init = function init() {
    ...
    tabs.forEach(function (t) {
      return t.addEventListener('click', _this.tabClick);
    });
  };
  ...
  obj.tabClick = function tabClick(e) {
    ...
    var tabPanels = tabContainer.querySelectorAll('[role="tabpanel"]'); // Remove selected from all tabs
    ...
    tabPanels.forEach(function (t) {
      return t.setAttribute('hidden', true);
    }); // Set selected tab panel

    var activeTabPanel = Array.from(tabPanels).filter(function (tabPanel) {
      return tabPanel.getAttribute('id') === tab.getAttribute('aria-controls');
    });
